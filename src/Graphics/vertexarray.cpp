...
Vao::Vao() { /* glCall(glad_glGenVertexArrays(1, &m_Id));*/
}
...
void inline Vao::bind() const { glCall(glBindVertexArray(m_Id)); }
void inline Vao::unbind() const { glCall(glBindVertexArray(0)); }
} // namespace graphics
